...
def main():
    ...
    if data_args.k_fold_cross_valid > 1:
        for i in range(data_args.k_fold_cross_valid):
            if not os.path.exists(training_args.output_dir + '/Split-' + str(i + 1)):
                os.makedirs(training_args.output_dir + '/Split-' + str(i + 1))
    ...
    if data_args.dataset_name is not None:
        ...
        try:
            ...
            cur_datasets = []
            try:
                if 'covid' in all_datasets.data:
                    covid_data = all_datasets['covid']

                elif 'train' not in all_datasets.data:
                    print('////////////////////////////////////////////////////////////////////')
                    print('////////////////////////////////////////////////////////////////////')
                    print('             Using the default covid_qa values')
                    print('////////////////////////////////////////////////////////////////////')
                    print('////////////////////////////////////////////////////////////////////\n')
            ...
            try:
                bio_dataset = all_datasets['bio']
                out_of_domain_dataset.append(bio_dataset)
            except:
                ...
                print('                 BioASQ data not included')
                print('88888888888888888888888888888888888888888888888888888888888888888888')
                print('11111111111111111111111111111111111111111111111111111111111111111111')

            try:
                squad_dataset = all_datasets['squad']
                out_of_domain_dataset.append(squad_dataset)
            except:
                if 'train' not in datasets.data:
                    print('11111111111111111111111111111111111111111111111111111111111111111111')
                    print('88888888888888888888888888888888888888888888888888888888888888888888')
                    print('                SQuAD data not included')
                    print('88888888888888888888888888888888888888888888888888888888888888888888')
                    print('11111111111111111111111111111111111111111111111111111111111111111111')
        ...
        if data_args.k_fold_cross_valid > 1:
            ...
            cur_datasets = load_dataset('custom_squad.py', data_files=data_files,
                                        split=[f'train[{k}%:{k + int(100 / k_fold)}%]' for k in
                                               range(0, 100, int(100 / k_fold))])
        else:
    ...
    for i in range(0, data_args.k_fold_cross_valid):
        ...
        if data_args.k_fold_cross_valid > 1:
            training_args.output_dir = output_dir + '/Split-' + str(i + 1)
            folds = cur_datasets.copy()
            datasets = {}
            datasets["validation"] = folds.pop(i)

            if training_args.do_predict and data_args.k_fold_cross_valid > 2:
                val_test = datasets["validation"].train_test_split(test_size=0.5)
